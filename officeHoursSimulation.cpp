...
void sort(ifstream& inStream, string direction, multimap<string, string>& record);
...
int main()
{
        ...
        cout << "Would you like to sort the topics in ascending order? (Enter yes/no)" << endl;
        getline(cin, direction);
        if(direction == "yes")
        {
            sort(in, direction, record);
        }
    ...
    averageQuestionTime += avQuestionTime;
        ...
        void sort(ifstream& inStream, string direction, multimap<string, string>& record)
        {
            ...
            while(inStream >> column)
            {
                ...
                if(column == "Student1" || column == "Student2" || column == "Student3" || column == "Student4" || column == "Student5" || column == "Student6" || column == "Student7" || column == "Student8" || column == "Student9" || column == "Student10" || column == "Student11" || column == "Student12" ||
                column == "Student13" || column == "Student14" || column == "Student15" || column == "Student16" || column == "Student17" || column == "Student18" || column == "Student19" || column == "Student20")
                {
                    for(int i = 0; i < 20; i++)
                    {
                        array[i] = column;
            ...
            for(i = 1; i < 20; i++)
            {
                ...
                for(j = index - 1; j < 20; j++)
                {
                    ...
                    //comparing end numbers on student names
                    if(k < l)
                    {
                        index = j;
                    }
